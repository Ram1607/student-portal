				...
				<div class="login-screen">
					...
					<form method="post" action="#" id="myform" autocomplete="off">
						<div class="login-form">
										...
										<div class="control-group">
												<input type="date" class="login-field" onclick="dateob()" value="" placeholder="Date of birth: dd/mm/yy" id="dob" name="dob" max="2005-01-01" min="1960-01-01">
		...
		<div class="modal-content1">
			...
			<div class="login">
				<div class="login-screen">
					...
					<form method="post" action="#" id="myform2" autocomplete="off">
						<div class="login-form">
